...
set_query_var('option_type', 'accommodation');
set_query_var('post_type', 'tytoaccommodations');
            ...
            <div id="primary" <?php kava_primary_content_class(); ?>>
                ...
                <main id="main" class="site-main"><?php
                    while ( have_posts() ) : the_post();
                        kava_theme()->do_location( 'single', 'template-parts/single-tytoaccommodations/content' );
...
wp_enqueue_style('single-tytoaccommodations');
wp_localize_script('tour-single', 'TourVars', [
    'parallax' => $parallax,
    'header_video' => get_theme_mod('accommodation_header_video', false),
    'header_video_autoplay' => get_theme_mod('accommodation_header_video_autoplay', false),
